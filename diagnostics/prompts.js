  ...
  "findings": [
    {
      ...
      "remediation_actions": [
        {
          "action_type": "restart_pod|restart_deployment|scale_deployment|delete_pod|cordon_node|uncordon_node|adjust_resources|rollback_deployment|delete_job",
          "target_kind": "Pod|Deployment|Node|Job",
