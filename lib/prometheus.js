...
// fetchAlerts() was removed 2026-08-12 — the auto-install stack never
// deploys vmalert, so this always returned `[]` in production (measured
// across all 24 live clusters). See lib/collectors.js for the rest of the
// alert-ingest retirement.
