...
const swaggerDocument = {
  ...
  info: {
    ...
    version: '1.0.0',
    description: 'Kubernetes cluster metriklerini mobil uygulamalar için optimize edilmiş JSON formatında sunan REST API.',
  ...
  paths: {
    ...
    '/metrics/overview': {
      get: {
        ...
        description: 'Mobil dashboard için tüm özet bilgileri tek endpoint\'te sunar',
        responses: {
          '200': {
            description: 'Cluster özeti',
            content: { 'application/json': { schema: { $ref: '#/components/schemas/OverviewResponse' } } }
          }
        }
      }
    },
      ...
      get: {
        ...
        responses: {
          '200': {
            ...
            content: { 'application/json': { schema: { $ref: '#/components/schemas/NamespaceResponse' } } }
          }
        }
      }
    },
      ...
      get: {
        ...
        responses: {
          '200': {
            ...
            content: { 'application/json': { schema: { $ref: '#/components/schemas/PodResponse' } } }
          }
        }
      }
    },
    '/metrics/pvc': {
      get: {
        tags: ['Metrics'],
        summary: 'PVC List',
        description: 'PersistentVolumeClaim\'lerin kapasitesi ve kullanımını gösterir',
        responses: {
          '200': {
            description: 'PVC listesi',
            content: { 'application/json': { schema: { $ref: '#/components/schemas/PvcResponse' } } }
          }
        }
      }
    },
    ...
    schemas: {
      ...
      NamespaceResponse: {
        ...
        properties: {
          ...
          namespaces: { type: 'array', items: { type: 'string' }, example: ['default', 'kube-system', 'monitoring'] }
        }
      },
      NodeResponse: {
        type: 'object',
      ...
      Pod: {
        ...
        properties: {
          ...
          phase: { type: 'string', enum: ['Running', 'Pending', 'Failed', 'Succeeded', 'Unknown'], example: 'Running' },
          cpu: {
            type: 'object',
            properties: {
      ...
      Alert: {
        ...
        properties: {
          ...
          state: { type: 'string', enum: ['firing', 'pending'], example: 'firing' },
          namespace: { type: 'string', example: 'production' },
          summary: { type: 'string', example: 'Memory usage is above 90% on node-2' },
          activeAt: { type: 'string', format: 'date-time', example: '2026-01-22T08:30:00Z' }
        }
      },
      ErrorResponse: {
        type: 'object',
